...
class ApiModule {
    ...
    @Provides
    @ApiScope
    fun providesRecipientRemoteDataSource(serverCommunicator: ServerCommunicator): RecipientRemoteDataSource {
        return RecipientRemoteDataSourceImpl(serverCommunicator)
    }
