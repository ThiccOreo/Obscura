...
class RepositoryModule {
    ...
    @RepositoryScope
    @Provides
    internal fun providesRecipientRepository(recipientRemoteDataSource: RecipientRemoteDataSource, recipientDataSource: RecipientDataSource): RecipientRepository {
        return RecipientRepositoryImpl(recipientRemoteDataSource, recipientDataSource)
    }
}